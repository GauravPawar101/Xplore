 ...
 *
 * Rendered as a small circle. It is NOT expandable and does NOT
 * open the detail panel on click. Only shows which user-code nodes
 * depend on this package (inbound focus highlight).
 */
export const LibraryNode = memo(function LibraryNode({ data }: NodeProps) {
    ...
    return (
        ...
        >
            {/* Invisible handles so edges connect properly */}
            <Handle
                type="target"
